...
class AdaptiveNeuralRouter:
    ...
    def _policy(self, masked: List[str]) -> Dict[str, float]:
        ...
        # ε-greedy exploration bias toward fast route when safe
    ...
    def credit_immediate(self, decision_id: str, latency_s: float, tri_delta: float) -> None:
        ...
        # TODO Phase 5.1: Update bandit coefficients here
