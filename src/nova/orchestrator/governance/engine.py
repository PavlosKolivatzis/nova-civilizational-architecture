...
from nova.orchestrator.governance.ethics import EthicsCheck, evaluate_ethics
from nova.orchestrator.governance.state_ledger import GovernanceLedger
from nova.orchestrator.prometheus.governance_metrics import record_governance_result
from nova.orchestrator.router.constraints import _tri_signal_from_request as _tri_signal  # type: ignore
from nova.orchestrator.router.constraints import _slot07_state as _slot07_state  # type: ignore
from nova.orchestrator.router.constraints import _slot10_state as _slot10_state  # type: ignore
from nova.orchestrator.router.constraints import _current_thresholds as _current_thresholds  # type: ignore
from nova.orchestrator.temporal.ledger import TemporalLedger
from nova.orchestrator.temporal.engine import TemporalEngine, TemporalSnapshot
from nova.orchestrator.temporal.adapters import (
    read_temporal_snapshot,
    read_temporal_router_modifiers,
    read_temporal_ledger_head,
)
from nova.orchestrator.predictive.trajectory_engine import PredictiveTrajectoryEngine, PredictiveSnapshot
from nova.orchestrator.predictive.adapters import (
...
from nova.orchestrator.predictive.consistency import compute_consistency_gap, ConsistencyProfile
from nova.orchestrator.predictive.memory_resonance import get_memory_window
from nova.orchestrator.predictive.ris_calculator import compute_ris, ris_to_dict
...
class GovernanceEngine:
    ...
    def _compute_and_publish_ris(self, temporal_snapshot: TemporalSnapshot, timestamp: float) -> None:
        ...
        try:
            from nova.orchestrator.prometheus_metrics import record_ris_score
