...
def get_peer_health() -> Dict[str, object]:
    ...
    try:
        from nova.orchestrator.federation_poller import get_last_ledger
    ...
    try:
        from nova.orchestrator.federation_remediator import get_last_event
    ...
    try:
        from nova.orchestrator.peer_store_singleton import get_peer_store
