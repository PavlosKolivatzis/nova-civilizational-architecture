...
def health() -> Dict[str, Any]:
    ...
    try:
        ...
        try:
            from nova.slots.slot08_memory_ethics.ids_protection import check_memory_write_eligibility
            from nova.slots.slot08_memory_ethics.lock_guard import MemoryLock
